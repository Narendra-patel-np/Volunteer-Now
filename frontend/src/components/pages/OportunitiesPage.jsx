...
import {Image,Container,VStack,Heading,Grid,Box,Text,Button,Modal,ModalOverlay,ModalContent,ModalHeader,ModalCloseButton,ModalBody,ModalFooter} from '@chakra-ui/react';
      ...
      <VStack spacing={4} align="stretch">
        ...
        <Grid templateColumns={{ base: '1fr', md: 'repeat(2, 1fr)', lg: 'repeat(3, 1fr)', xl: 'repeat(4, 1fr)' }} gap={4}>
          {jobs.map((job) => (
            ...
            >
              <Image src="https://via.placeholder.com/300" alt={job.title} mb={4} zIndex={-100}/>
        ...
        <Modal isOpen={isModalOpen} onClose={closeModal} size="lg">
          ...
          <ModalContent>
            ...
            <ModalCloseButton />
            <ModalBody>
              <Image src="https://via.placeholder.com/600" alt={selectedJob?.title} mb={4} />
              ...
              <Text mt={4}>
                <strong>Date:</strong> {selectedJob?.date}, <strong>Time:</strong> {selectedJob?.time}
              </Text>
              <Text mt={2}>
                <strong>Contact:</strong> {selectedJob?.contact.name}, {selectedJob?.contact.email}, {selectedJob?.contact.phone}
              </Text>
            </ModalBody>
            <ModalFooter>
